    ...
    return (
        <div className="mb-4">
            ...
            <Typography className="mb-2" variant="paragraph" color="black">
                Deleting this board will also delete all data associated with it
            </Typography>
            <Button size="sm" variant="gradient" color="red" className="w-full mx-auto " onClick={toggleDelete}>
